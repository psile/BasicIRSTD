...
class TrainSetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        #pdb.set_trace()
        try:
            img = Image.open((self.dataset_dir + '/images/' + str(self.train_list[idx]) + '.png').replace('//','/')).convert('I')
            mask = Image.open((self.dataset_dir + '/masks/' + str(self.train_list[idx]) + '.png').replace('//','/'))
        except:
            img = Image.open((self.dataset_dir + '/images/' + str(self.train_list[idx]) + '.bmp').replace('//','/')).convert('I')
            mask = Image.open((self.dataset_dir + '/masks/' + str(self.train_list[idx]) + '.bmp').replace('//','/'))
