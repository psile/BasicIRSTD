...
parser.add_argument("--pth_dirs", default=['NUAA-SIRST/ACM_200.pth.tar'], type=list, help="checkpoint dir, default=None or ['NUDT-SIRST/ACM_400.pth.tar','NUAA-SIRST/ACM_400.pth.tar']")
...
if __name__ == '__main__':
    ...
    if opt.pth_dirs == None:
        for i in range(len(opt.model_names)):
            ...
            opt.f.write(opt.model_name + '_200.pth.tar' + '\n')
