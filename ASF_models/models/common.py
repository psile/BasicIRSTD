...
from utils_asf import TryExcept
from utils_asf.dataloaders import exif_transpose, letterbox
from utils_asf.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
                           increment_path, is_notebook, make_divisible, non_max_suppression, scale_boxes, xywh2xyxy,
                           xyxy2xywh, yaml_load)
from utils_asf.plots import Annotator, colors, save_one_box
from utils_asf.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from utils_asf.downloads import is_url
