...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='E://datasets//tiny_detection//PRCV2024//Dataset-mask//val', help='file/dir/URL/glob/screen/0(webcam)')#ROOT / 'datasets/images/val'
    parser.add_argument('--data', type=str, default=ROOT / 'data/PRCV.yaml', help='(optional) dataset.yaml path')
